      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.subHeaderContainer}>
          <TouchableOpacity onPress={() => setDropdownVisible(!dropdownVisible)} style={styles.dropdownButton}>
            <Text style={styles.subHeader}>Friends Only v</Text>
          </TouchableOpacity>
        </View>
        ...
        {dropdownVisible && (
          <View style={styles.dropdownMenu}>
            ...
            <TouchableOpacity
              onPress={() => {
                setDropdownVisible(false);
                router.push("/expanded-tabs/localsOnly"); // Navigate to Locals Only page
              }}
            >
              <Text style={styles.dropdownItem}>Locals Only</Text>
            </TouchableOpacity>
          </View>
        )}
